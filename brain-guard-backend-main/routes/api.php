...
use App\Http\Controllers\Patient\QuestionnaireController;
...
use App\Http\Controllers\Doctor\QrScanController;
...
Route::prefix('v1')->group(function () {
    ...
    Route::middleware(['auth:sanctum', 'role:patient'])->prefix('patient')->group(function () {
        ...
        Route::post('questionnaire-predict', [QuestionnaireController::class, 'predict']);
    ...
    Route::middleware(['auth:sanctum', 'role:doctor'])->prefix('doctor')->group(function () {
        ...
        Route::post('scan-qr', [QrScanController::class, 'store']);
